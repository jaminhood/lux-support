...
?>
<div class="error-text px-5">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50%" height="50%" viewBox="0 0 398.1 226.6" style="enable-background:new 0 0 398.1 226.6;" xml:space="preserve">
    ...
    <div class="d-flex justify-content-center align-items-center flex-column">
        ...
        <a href="<?php echo site_url('./') ?>" class="btn mt-2 btn-primary">Back to Home</a>
    </div>
</div>